...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/d4.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/d5.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/d6.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/d7.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/k1.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/dharamshala1.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/k2.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/d2.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Dhramshala</h3>
                <p> Dharamshala, nestled in the scenic Himalayas, is a serene hill station known for its Tibetan culture and stunning landscapes. It's the perfect destination for peace seekers, nature lovers, and spiritual explorers.</p>
            </div>
