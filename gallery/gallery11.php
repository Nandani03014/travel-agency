...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/t4.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/t5.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/t6.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/t7.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/t8.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/t9.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/t10.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/t11.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Tirthan</h3>
                <p> Tirthan Valley, nestled in Himachal Pradesh, is a serene paradise known for its crystal-clear river and lush greenery. Perfect for nature lovers, it offers peaceful retreats and thrilling adventures alike.</p>
            </div>
