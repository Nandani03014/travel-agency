...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/u5.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/deh4.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/deh1.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/u8.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/u9.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/deh2.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/u11.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/deh3.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Dehradun</h3>
                <p>Dehradun, the gateway to the hills of Uttarakhand, is known for its pleasant climate, green valleys, and prestigious educational institutions.
                It serves as a perfect base to explore nearby hill stations like Mussoorie, Rishikesh, and Haridwar.</p>
            </div>
