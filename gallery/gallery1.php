...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/gallery1.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/g2.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/gallery3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/g4.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/g5.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/g6.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/g7.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/g8.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Manali</h3>
                <p> Manali, a breathtaking hill station in Himachal Pradesh, is known for its snow-capped mountains, lush valleys, and adventure sports. Visit for thrilling activities like paragliding and skiing, or simply to relax amidst its scenic beauty and vibrant culture. </p>
            </div>
