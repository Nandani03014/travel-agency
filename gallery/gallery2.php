...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/a.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/a1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/a2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/a3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/a4.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/a5.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/a6.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/a7.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Lahul-Spiti</h3>
                <p> Spiti, known as the "Middle Land" between India and Tibet, offers breathtaking landscapes, ancient monasteries, and thrilling high-altitude adventures. From mesmerizing snow-capped peaks to serene villages, it's a paradise for nature lovers and adventure seekers alike </p>
            </div>
