...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            ...
            <div class="item"><img src="../images/dal2.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/j3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/dal3.jpg" alt="Painting 3"></div>
            ...
            <div class="item text-box">
                <h3>Dal Lake</h3>
                <p> Perfect! 🏞️ Dal Lake, located in Srinagar (Jammu & Kashmir), is famous for its shikara rides, floating markets, and beautiful houseboats..</p>
            </div>
