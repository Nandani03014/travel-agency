...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/manali.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/kullu6.webp" alt="Painting 2"></div>
            <div class="item"><img src="../images/kullu5.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/kullu.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/kullu1.webp" alt="Painting 4"></div>
            <div class="item"><img src="../images/kullu3.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/kullu2.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/kullu4.jpeg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Kullu</h3>
                <p> Kullu-Manali is a breathtaking Himalayan destination famous for its snow-capped peaks, adventure sports, and scenic beauty.
                It’s a paradise for honeymooners, trekkers, and those looking to explore the charm of Himachal’s valleys and rivers..</p>
            </div>
