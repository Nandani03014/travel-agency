...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/chardham.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/char1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/char2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/char3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/char4.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/char5.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/char6.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/char7.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Char Dham Yatra</h3>
                <p> The Char Dham Yatra is a sacred journey to the four holy shrines of Uttarakhand, drawing millions of devotees each year.
Surrounded by the majestic Himalayas, it offers not just spiritual upliftment but also breathtaking natural beauty.
