...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/ch.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/ch1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/ch2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/chamba1.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/ch4.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/ch5.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/ch6.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/ch7.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Chamba</h3>
                <p> Chamba, nestled in the lap of the Himalayas, is known for its serene landscapes, ancient temples, and rich cultural heritage.
                It’s a perfect getaway for nature lovers, history enthusiasts, and those seeking peace away from the bustling cities. </p>
            </div>
