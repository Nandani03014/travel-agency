...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/gallery.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/gallery1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/gallery2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/gallery3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/gallery4.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/gallery5.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/gallery6.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/gallery7.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Shimla</h3>
                <p> Shimla, the capital of Himachal Pradesh, is a picturesque hill station known for its colonial architecture and scenic beauty. Nestled in the Himalayas, it offers breathtaking views, pleasant weather, and a rich cultural heritage. Come visit Shimla, where misty mountains, colonial charm, and scenic landscapes await you! Experience the perfect blend of adventure, serenity, and heritage in this beautiful hill station. </p>
            </div>
