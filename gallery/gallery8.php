...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            ...
            <div class="item"><img src="../images/u6.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/u7.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/u8.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/u9.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/u10.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/u11.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/u12.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Uttrakhand</h3>
                <p>Uttarakhand, often called the "Dev Bhoomi" (Land of the Gods), is a serene blend of spirituality and adventure. From the sacred Ganga in Rishikesh to the snow-capped peaks of Auli, it’s perfect for both peace seekers and thrill lovers</p>
            </div>
