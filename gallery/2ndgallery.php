...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/tara.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/tara1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/tara2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/gallery.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/tara4.jpg" alt="Painting 4"></div>
