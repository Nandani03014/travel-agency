...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/kk.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/kasol1.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/kasol2.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/kasol3.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/kasol4.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/kasol5.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/kasol6.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/kasol7.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Kasol</h3>
                <p> Kasol, nestled in the Parvati Valley of Himachal Pradesh, is a scenic hamlet known for its lush landscapes, riverfront beauty, and bohemian vibe. It's a perfect getaway for nature lovers, trekkers, and those seeking peace or vibrant café culture amidst the Himalayas. </p>
            </div>
