...
.text-box h3 {
   ...
   <div class="container my-5">
        <div class="gallery-grid">
            <div class="item"><img src="../images/l5.jpg" alt="Painting 1"></div>
            <div class="item"><img src="../images/l6.jpg" alt="Painting 2"></div>
            <div class="item"><img src="../images/l7.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/l8.jpg" alt="Painting 3"></div>
            <div class="item"><img src="../images/l9.jpg" alt="Painting 4"></div>
            <div class="item"><img src="../images/l10.jpg" alt="Painting 5"></div>
            <div class="item"><img src="../images/ladakh.jpg" alt="Painting 6"></div>
            <div class="item"><img src="../images/ladakh1.jpg" alt="Painting 6"></div>


            <!-- Text Box -->
            <div class="item text-box">
                <h3>Ladakh</h3>
                <p> Ladakh, the "Land of High Passes," is a dream destination with dramatic mountain views, crystal-clear lakes, and a rich blend of Tibetan culture. Perfect for thrill-seekers and peace-lovers alike, it’s a place where adventure meets spirituality</p>
            </div>
