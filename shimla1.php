...
<style>
    ...
    .overlay {
        ...
        background: url('images/shimla.jpg') center/cover no-repeat;
        color: white;
        font-size: 18px;
        border-radius: 10px;
...
<div class="container mt-4">
    <div class="gallery">
        ...
        <div class="overlay">
            <a href="gallery/gallery.php">View More Images</a>
        </div>
    </div>
</div> 
...
<p style="font-size: 20px; margin-left: 20px;">✔️Night Hotel Stay in Shimla<br><br>
✔️Breakfast & Dinner<br> <br>
✔️Sightseeing by Private Cab <br> <br>
✔️Pick & Drop from Shimla <br> <br>
❌Train/Bus/Airfare Tickets <br> <br>
❌Entry Fees & Personal Expenses </p> <br>
<h4 style="margin-left: 20px;"> Cost Involved </h4>
<p style="font-size: 20px; margin-left: 20px;">Shimla Package 3 night 4 days <br><br>
₹10,000 
₹7,600
5 Days
Availability : Jan 16’ - Dec 16’<br><br>
Book 3 night 4 days Package of Shimla and enjoy the view of hills. […]
10% off <br><br>
      </p>
...
<p style="font-size: 20px; margin-left: 20px;">A. Tara Devi Temple – A spiritual retreat with stunning hilltop views.  <br><br>
B. Jakhoo Temple – Famous for its towering Hanuman statue. <br><br>
C. Mall Road & Ridge – Explore the heart of Shimla. <br><br>
D. Scenic Beauty – Enjoy lush green valleys and pine forests. <br><br>
E. Local Shopping & Food – Try Himachali delicacies and shop for souvenirs </p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2. Tara Devi Temple Visit and Departure
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Breakfast at the hotel. Drive to Tara Devi Temple, located on a scenic hilltop. 
                            Seek blessings and enjoy breathtaking views of the valley. Optional visit to Kali 
                            Bari Temple & Indian Institute of Advanced Studies. Drop-off at Shimla Bus Stand/Railway Station for onward journey.
                            </div>
                        </div>
                    </div>
...
<div class="form-popup" id="upiScanner" style="display:none;">
  ...
  <img src="images/upi.png" alt="UPI QR Code" style="width: 450px; height: 500px; margin-top: 10px;">
</div>
...
<script>
  ...
  const vehicleInputBox = document.getElementById('vehicleInputBox');

  selectVehicle.addEventListener('click', () => {
    selectVehicle.style.display = 'none';
    vehicleInputBox.style.display = 'block';
    vehicleInputBox.focus();
  });
</script>
...
function submitBooking() {
  ...
  fetch('sendBookingEmail.php', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ name, email, phone, vehicle, date })
  })
  .then(res => res.text())
  .then(data => {
    alert('Booking confirmed and email sent to admin!');
    showPaymentOptions(); // Move to payment step
  })
  .catch(err => {
