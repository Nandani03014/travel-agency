...
<div class="container mt-4">
    <div class="gallery">
        <div class="large">
            <img src="../images/jungle.jpg" alt="Main Image">
        </div>
        <div>
            <img src="../images/jungle1.jpg" alt="Small Image">
        </div>
        <div>
            <img src="../images/jungle2.jpg" alt="Small Image">
        </div>
        <!-- Video Instead of Image 3  -->
        <div class="overlay2">
            <video controls style=" height: 450px; max-width: 700px;">
                <source src="../vedio/jungle.mp4" type="video/mp4">
...
<div class="tour-info" style="margin-left: 20px; margin-top: 20px;">
    ...
    <div class="location">
        <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="Location Icon">
         Himachal Pradesh , Jungle Hiking
    </div>  
</div> <br>

<h4 style="margin-left: 20px;"> Included and Excluded </h4> <br>
<p style="font-size: 20px; margin-left: 20px;">✔️3 Nights Accommodation in Shimla<br><br> 
✔️Daily Breakfast & Dinner<br><br> 
✔️Guided Hiking Tours & Trek Permits<br><br> 
✔️Private Cab for Sightseeing<br><br> 
✔️Pickup & Drop from Shimla <br><br> 
❌Train/Bus/Airfare Tickets<br><br>
❌Personal Expenses & Entry Fees<br><br>
   


<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Chadwick Falls – A hidden jungle waterfall.<br><br>
Glen Forest Hike – A peaceful walk through pine forests.<br><br>
Chharabra Jungle Trail – A scenic hike near Kufri.<br><br>
Wildlife Spotting – Look out for Himalayan Monals & Barking Deer.<br><br>
Tara Devi Temple Trek – A serene hike with breathtaking views </p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Arrival In Shimla and Local Exploration
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Arrive in Shimla (by bus/train/private vehicle). Check-in at the hotel and freshen up. Visit The Ridge, Mall Road, and Christ Church. Explore the historic Jakhoo Temple, home to playful monkeys. Enjoy a delicious dinner & overnight stay in Shimla.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2. Shimla to Glen Forest and Chadwick Falls Hike
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, start the Glen Forest Hike. Walk through dense pine & deodar forests with stunning views. Reach Chadwick Falls, a hidden waterfall amidst the jungle. Enjoy a packed lunch in nature. Return to Shimla and relax at your hotel.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3. Shimla To Kufri and Chharabra Jungle Hike
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning drive to Kufri, a scenic hilltop. Begin the Chharabra Jungle Hike, walking through wild cedar forests. Spot rare Himalayan birds & wildlife along the way. Visit Mahasu Peak, the highest point in Kufri. Enjoy adventure activities (optional: ziplining, horse riding). Return to Shimla for an overnight stay.
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                4.Tara Devi Temple Hike And Departure
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, hike to Tara Devi Temple, a peaceful trek through the woods. Enjoy panoramic views of Shimla & the surrounding valleys. Descend back and check out from the hotel. Transfer to Shimla Bus Stand/Train Station for departure.
                            </div>
                        </div>
                    </div>
</div>
