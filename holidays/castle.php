...
<p style="font-size: 20px; margin-left: 20px;">Visit the majestic Naggar Castle<br><br>
Explore ancient Himachali architecture and craftsmanship<br><br>
Panoramic views of Kullu Valley and snow-capped mountains<br><br>
Visit the Naggar Castle Museum (optional)<br><br>
Nearby attractions: Tripura Sundari Temple, Roerich Art Gallery</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Visit To Naggar Castle
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location Scenic drive through Kullu Valley Reach Naggar Castle, explore the castle’s architecture and museum Enjoy breathtaking views of the valley Visit the Tripura Sundari Temple nearby Check-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            MorExplore Roerich Art Gallery or local Kullu attractions Breakfast at a local café (if included) Start return journey, with scenic stops Reach home safely by evening
                            </div>
                        </div>
                    </div>
