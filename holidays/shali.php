...
<p style="font-size: 20px; margin-left: 20px;">✔ Transport To/From The Trek Starting Point (Bike, Car, Or Tempo Traveller) <br><br>
✔ Trek Guide For Assistance <br><br>
✔ Basic First Aid Kit <br><br>
✔ Trekking Permits (If Required) <br><br>
✔ Packed Snacks & Refreshments <br><br>
✔ Camping & Bonfire (If Included) <br><br>
✔ Accommodation (If Included) <br><br>
✔ Daily Breakfast & Dinner (If Included) <br><br>
❌ Personal Expenses (Food, Drinks, Shopping, Etc.) <br><br>
❌ Travel Insurance & Medical Expenses <br><br>
❌ Any Emergency Evacuation Costs <br><br>
❌ Extra Trekking Gear (Trekking Poles, Jackets, Etc.) <br><br>
❌ Entry Fees For Tourist Attractions (If Applicable) <br><br>
❌ Toll & Parking Charges <br><br> </p>
<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Trek to Shali Tibba Peak (2,870 meters)<br><br>
  
Breathtaking Views of Himalayan ranges<br><br>
  
Peaceful & Offbeat Location – Away from crowds<br><br>
  
Visit Shali Mata Temple at the summit<br><br>
  
Camping & Bonfire (if included) – Enjoy nature’s beauty<br><br>
  
Explore Local Villages & Forest Trails</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Early morning departure from your location Reach Khatnol Village (Trek starting point)Begin trek to Shali Tibba (~3-4 hours)Enjoy scenic views, nature photography, and temple visit Relax at the peak, enjoy snacks, and explore the surroundingsTrek down to the base and return to hotel/campsite (if included)
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning breakfast at campsite/hotel (if included) Explore nearby villages or waterfalls (optional)Start return journey with scenic stops Reach home safely by evening
                            </div>
                        </div>
                    </div>
