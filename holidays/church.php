...
✔️Experienced Driver/Rider Assistance (if required)<br><br>
✔️Entry Tickets to Christ Church (if included)<br><br>
✔️Basic First Aid Kit<br><br>
✔️Route Map & Tour Guide Assistance<br><br>
✔️Accommodation (if included)<br><br>
✔️Daily Breakfast (if included)<br><br>
...
❌Additional Sightseeing or Entry Fees<br><br> </p>
<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Visit the iconic Christ Church<br><br>
Admire the neo-gothic architecture and stained-glass windows<br><br>
Experience the peaceful ambiance for reflection and prayer<br><br>
Located near The Ridge, with panoramic views of Shimla<br><br>
Nearby attractions: Mall Road, Jakhoo Temple, Shimla Ridge</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Church Visit
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location Scenic drive to Shimla through picturesque landscapes Reach Christ Church, explore its architecture and historyEnjoy a peaceful moment inside the church or attend a service (if available) Visit nearby attractions like Mall Road or Jakhoo Temple Check-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Explore other attractions in Shimla or take a walk on The Ridge Breakfast at a local café (if included) Start return journey, with scenic stops Reach home safely by evening
                        </div>
                    </div>
