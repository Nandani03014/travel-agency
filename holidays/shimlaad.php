...
<p style="font-size: 20px; margin-left: 20px;">✔Accommodation in premium hotels/camps<br><br>
✔Daily breakfast and dinner<br><br>
✔Adventure activity bookings (as per itinerary)<br><br>
✔Private vehicle for sightseeing and transfers<br><br>
✔Professional guides and safety equipment<br><br>

❌ Airfare/train tickets
❌Personal expenses, tips, and extra activities
❌Permit fees for Rohtang Pass (if applicable)
❌Travel insurance<br><br> </p>
<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Enjoy paragliding, river rafting, and skiing (seasonal) in Kufri & Narkanda.  <br><br>
Trek to Hatu Peak and witness breathtaking Himalayan views. <br><br>
Indulge in thrilling river rafting at Tattapani. <br><br>
Experience a zip-lining and rope adventure course in Chail. <br><br>
Explore off-road trails and mountain biking in the Shimla hills</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Arrive in Shimla and check into your adventure-themed hotel. Explore The Ridge, Mall Road, and Jakhoo Temple trek. Visit Johnnie’s Wax Museum and try local Himachali cuisine. Overnight stay in Shimla.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2.Kufri Adventure Activities and Skking
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Depart for Kufri, a hub of winter sports and adventure. Experience skiing, snowboarding, and sledging (in winters). Visit Kufri Fun World for go-karting and amusement rides. Explore the Himalayan Nature Park and ride a yak! Overnight stay in Kufri/Shimla.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3.Narkanda Trek and Hatu Peak
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure for Narkanda, known for its pristine beauty. Trek to Hatu Peak (3400m), the highest point in the region. Enjoy panoramic views and a picnic at the summit. Return to Shimla for an overnight stay.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                4.River Rafting In TAttapani and Hot Springs
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Head to Tattapani, a paradise for adventure lovers. Experience thrilling white-water rafting on the Sutlej River. Relax in natural hot springs, known for their healing properties. Enjoy a riverside bonfire and return to Shimla for an overnight stay.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                                4.Chail Rope Adventure and Departure
                            </button>
                        </h2>
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Travel to Chail, a peaceful hill station known for its adventure parks. Experience zip-lining, rock climbing, and rope obstacle courses. Visit the Chail Palace and Cricket Ground (highest in the world). Depart for onward journey with unforgettable adventure memories!
                            </div>
                        </div>
                    </div>
