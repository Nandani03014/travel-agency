...
<p style="font-size: 20px; margin-left: 20px;">Explore the historic Gaiety Theatre<br><br>
Admire the Victorian architecture and interiors<br><br>
Attend a live performance (if available)<br><br>
Visit the Shimla Heritage Museum nearby<br><br>
Stunning views of Shimla from the theatre</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Gaeity Theatre Visit
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location Scenic drive to Shimla through picturesque landscapes Reach Gaiety Theatre, explore its history and architectureAttend a performance or enjoy a cultural event (if available) Visit the Shimla Heritage Museum nearby Check-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Explore Mall Road and other attractions in Shimla Breakfast at a local café (if included) Start return journey, with scenic stops
                            </div>
                        </div>
                    </div>
