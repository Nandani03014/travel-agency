...
<p style="font-size: 20px; margin-left: 20px;">Minjar Mela Festival – Grand procession & cultural celebrations.<br><br>
Khajjiar (Mini Switzerland) – Scenic meadows & adventure activities.<br><br>
Dalhousie & Kalatop – Beautiful hill station experience.<br><br>
Manimahesh Temple – A sacred and peaceful pilgrimage site.<br><br>
Local Handicrafts & Food – Experience Himachali culture up close.
</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Arrive in Chamba (via Pathankot or Dharamshala). Check-in at the hotel and relax. Visit Chamba Chaugan, the festival ground of Minjar Mela. Explore Laxmi Narayan Temple, a beautiful ancient site. Visit Bhuri Singh Museum, showcasing Chamba’s royal history. Enjoy traditional Himachali cuisine & overnight stay in Chamba.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2.Minjar Mela Celebration
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, head to Chamba Chaugan for Minjar Mela. Witness cultural performances, folk dances, and music. Enjoy the Minjar Procession, where people offer "Minjar" (silken tassels) to the Ravi River. Explore the colorful fair, handicraft stalls & local food. Return to hotel for dinner & overnight stay.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, visit Manimahesh Lake (optional, seasonal trek or by helicopter). Explore Chamera Lake for boating and scenic views. Drop-off at Pathankot/Dharamshala for departure.
                            </div>
                        </div>
                    </div>
