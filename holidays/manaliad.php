...
<p style="font-size: 20px; margin-left: 20px;">Paragliding over the scenic valleys of Manali<br><br>
River rafting in the Beas River<br><br>
Skiing & snowboarding in Solang Valley<br><br>
ATV rides & zorbing in Rohtang Pass<br><br>
Camping under the starry sky<br><br>
Biking through Atal Tunnel & Lahaul Valley<br><br>
Trekking to scenic viewpoints<br><br>
Visit to the famous Hidimba Devi Temple</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Check-in at the hotel and freshen up. Explore Mall Road, Hadimba Temple, and Vashisht Hot Springs. Enjoy an evening at leisure. Overnight stay in Manali.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2.Solang Valley Adventure Activities
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Head to Solang Valley, a hub for adventure sports. Experience paragliding, skiing, and snowboarding (seasonal). Enjoy ATV rides, zorbing, and cable car rides. Return to Manali for an overnight stay.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3.Rohtang Pass and Atal Tunnel Excrusion
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Depart for Rohtang Pass (subject to permit availability). Experience sledging, snow biking, and snow scooter rides. Drive through the Atal Tunnel to explore Lahaul Valley. Return to Manali in the evening and rest.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                4.River Raftin and Camping Experience
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Enjoy river rafting in the Beas River. Drive to a riverside camping site for bonfire and music. Enjoy dinner under the stars and an overnight camping experience.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Breakfast and check-out. Depart with unforgettable adventure memories!
                            </div>
                        </div>
                    </div>
