                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Travel towards Guru Mandir, near the Shipki La Pass, where battles took place during the 1962 Indo-China war. Explore the historic surroundings and learn about the battle significance. Pay homage at the mandir, a site of spiritual and historical importance. Overnight stay near Shipki La.
                            </div>
                        </div>
                    </div>
...
<form  onsubmit="event.preventDefault(); sendEmail();">
  ...
  <div class="form-group mb-2">
    ...
    <input type="text" id="vehicle" class="form-control mt-2" placeholder="Enter vehicle name">
  </div>
