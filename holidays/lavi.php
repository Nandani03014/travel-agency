...
<p style="font-size: 20px; margin-left: 20px;">Visit the Lavi Mela, a historic trade fair with local handicrafts, woolen items, and cultural performances.<br><br>
Explore the Padam Palace, an architectural marvel in Rampur Bushahr.<br><br>
Witness the scenic beauty of the Satluj Riverside and enjoy a peaceful retreat.<br><br>
Experience the vibrant markets filled with traditional Pashmina, woolen items, and Tibetan artifacts.<br><br>
Enjoy cultural performances, folk music, and local delicacies at the fair.<br><br>
Take a scenic drive through the breathtaking landscapes of Himachal Pradesh.
</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Arrive in Shimla and check into your hotel. Explore the Mall Road, Ridge, and Jakhoo Temple. Enjoy the colonial charm of Shimla and local shopping. Overnight stay in Shimla.
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2.Transfer to Rampur and Local Exploration
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, drive towards Rampur Bushahr (135 km / 4-5 hours). Visit the magnificent Padam Palace, known for its royal heritage. Walk around the vibrant streets of Rampur, exploring the local culture. Overnight stay in Rampur Bushahr.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3.Lali Mela visit and Cultural 
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                           
                           Spend the day at the Lavi Mela, experiencing the rich heritage of the region. Explore traditional markets with woolens, handicrafts, and Pashmina shawls. Enjoy folk music, dance performances, and local cuisine. Visit the Satluj Riverside for a scenic break. Overnight stay in Rampur Bushahr.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Enjoy breakfast and check out from the hotel. Drive back to Shimla and explore any remaining attractions. Depart for your onward journey with beautiful memories.
                            </div>
                        </div>
                    </div>
