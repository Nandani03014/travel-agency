...
<p style="font-size: 20px; margin-left: 20px;">Ride to Mata Jawala Ji Temple<br><br>
Experience the eternal flame at the temple<br><br>
Enjoy scenic mountain roads and beautiful views<br><br>
Includes fuel, safety gear, and route assistance<br><br>
Comfortable stay and breakfast (if included)<br><br>
Explore nearby temples and local attractions<br><br></p>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Journey to Jawalaji
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your locationEnjoy a beautiful ride through hills and highwaysStop for breakfast and refreshments on the wayReach Jawala Ji Temple, attend Darshan & AartiExplore local markets and surroundingsCheck-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning visit to the temple for prayersExplore nearby temples (Chintpurni, Baglamukhi, etc.)Breakfast at a local restaurant (if included)Start return journey, with scenic stopsReach home safely by evening
                            </div>
                        </div>
                    </div>
