...
<p style="font-size: 20px; margin-left: 20px;">Visit the famous Baijnath Temple<br><br>
Enjoy breathtaking Himalayan views<br><br>
Comfortable travel options – Bike, Car, or Tempo Traveller<br><br>
Includes fuel, safety gear, and route assistance<br><br>
Stay in a comfortable hotel with breakfast (if included)<br><br>
Explore nearby attractions like Palampur, Bir Billing, and Kangra Fort</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Early morning departure from your locationScenic drive/ride through the Himalayan roadsStop for breakfast and refreshments on the wayReach Baijnath Temple, attend Darshan & PoojaExplore local markets and surroundingsCheck-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Morning visit to nearby attractions (Bir Billing, Palampur, etc.)Breakfast at a local restaurant (if included)Start return journey, with scenic stopsReach home safely by evening
                            </div>
                        </div>
                    </div>
