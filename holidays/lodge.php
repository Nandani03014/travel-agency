...
<p style="font-size: 20px; margin-left: 20px;">Explore the Viceregal Lodge – a British colonial masterpiece<br><br>
Visit the Indian Institute of Advanced Study<br><br>
Walk through the beautiful gardens surrounding the lodge<br><br>
Learn about Shimla’s British colonial history<br><br>
Stunning views of Shimla hills and surrounding valleys</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Journey to Viceregal Lodge Visit
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location Scenic drive to Shimla through picturesque landscapes Reach Viceregal Lodge, explore its history and architecture Visit the Indian Institute of Advanced Study Enjoy the gardens and panoramic views Check-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Explore Mall Road and nearby attractions in Shimla Breakfast at a local café (if included) Start return journey, with scenic stops Reach home safely by evening
                            </div>
                        </div>
                    </div>
