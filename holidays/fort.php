...
<p style="font-size: 20px; margin-left: 20px;">Visit the historic Sujanpur Fort<br><br>
Explore ancient architecture and royal history<br><br>
Panoramic views of Hamirpur Valley and surrounding hills<br><br>
Nearby attractions: Baba Balak Nath Temple, Majhi Falls<br><br>
Trekking and nature walks around the fort</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Journey to Sujanpur Fort Visit
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location Scenic drive to Sujanpur Fort through lush landscapes Reach the fort, explore its history and architecture Visit Baba Balak Nath Temple nearby Check-in at hotel (if included) and relax
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Explore Majhi Falls or other local attractions Breakfast at a local café (if included) Start return journey, with scenic stops Reach home safely by evening
                            </div>
                        </div>
                    </div>
