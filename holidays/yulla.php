...
✔️ Choice Of Transport (Bike, Car, Or Tempo Traveller)<br><br>
✔️ Fuel For The Planned Route<br><br>
✔️ Experienced Driver/Rider Assistance (If Required)<br><br>
✔️ Trek Guide For Yulla Kanda Temple Trek<br><br>
✔️ Entry To Yulla Kanda Temple (If Included)<br><br>
...
❌ Extra Fuel For Unplanned Routes<br><br>
❌ Toll & Parking Charges<br><br>
❌ Additional Sightseeing Or Entry Fees<br><br>
</p>

<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Trek to Yulla Kanda Temple through scenic Himalayan trails <br><br>
Explore Kinnaur's traditional villages and culture <br><br>
Stunning views of snow-covered peaks and valleys <br><br>
Visit the Yulla Kanda Temple, a peaceful and spiritual destination <br><br>
Nearby attractions: Chitkul, Rakcham Village, and Baspa River</p> <br><br>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Departure and Start Of Trek
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure from your location  Scenic drive to Kinnaur through beautiful mountain roads Reach the base of the trek at Chitkul or nearby village Begin the trek to Yulla Kanda Temple (3-4 hours) Reach the temple, explore the surroundings and take a break Return to the base (or camp) for overnight stay
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning breakfast and enjoy the scenic beauty Explore nearby villages of Kinnaur, interact with locals Start return journey with scenic stops at Rakcham and Baspa River Reach home safely by evening
                            </div>
                        </div>
                    </div>
