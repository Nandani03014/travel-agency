...
<div class="container mt-4">
    <div class="gallery">
        ...
        <div class="overlay">
            <a href="/int.php/des.php/gallery/gallery3.php">View More Images</a>
        </div>
    </div>
</div> 
...
✔️3 Nights Accommodation in Dharamshala <br><br> 
✔️Daily Breakfast & Dinner <br><br> 
✔️Private Cab for Sightseeing <br><br> 
✔️Pickup & Drop from Dharamshala<br><br> 
❌Airfare/train tickets <br><br>
❌Entry tickets to monuments/parks <br><br>

<h4 style="margin-left: 20px;"> Cost Involved </h4> <br>
<p style="font-size: 20px; margin-left: 20px;">A full tour of Shimla, Dharamshala and dalhousie 4 night 5 days by volvo. <br> <br>
₹12,999 <br>
₹10,999<br>
5 Days<br>
Availability : Jan 16’ - Dec 16’<br>
Book 5 days 4 nights Shimla Dalhousie Dharamshala Customized Holidays </p> <br> 


<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">A. Dalai Lama Temple – A spiritual retreat & monastery.<br>
B.Bhagsu Waterfall – A scenic waterfall near McLeod Ganj.<br>
C.Norbulingka Institute – Showcasing Tibetan art & culture.<br>
D.Kangra Fort – A historic fort with stunning valley views.<br>
E.Jwalamukhi Temple – A divine temple with a natural eternal flame.<br>
F.Maharana Pratap Sagar Lake – A serene lake with birdwatching spots.</p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2. Dharamshala and Mc Leod Ganj Sightseeing
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Breakfast at the hotel. Visit Dalai Lama Temple – A spiritual & peaceful monastery. Explore Norbulingka Institute, a hub for Tibetan art & culture. Visit St. John in the Wilderness Church, a beautiful British-era church. Enjoy free time in the evening at leisure or shopping. Overnight stay in Dharamshala.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3. Kangra Valley Excursion
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, drive to Kangra Valley, famous for its temples & history. Visit Kangra Fort, one of India’s oldest and largest forts. Seek blessings at Bajreshwari Devi Temple. Explore the scenic Maharana Pratap Sagar Lake (Pong Dam). Visit the famous Jwalamukhi Temple, known for its eternal flame. Return to Dharamshala for an overnight stay.
                            </div>
                        </div>
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Breakfast at the hotel. Free time for shopping or a leisure walk. Check out and transfer to the bus stand/airport for departure.
                            </div>
                        </div>
                    </div>
