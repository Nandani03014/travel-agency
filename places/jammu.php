...
<style>
    ...
    .overlay {
        ...
        background: url('../images/k4.jpg') center/cover no-repeat;
        color: white;
        font-size: 18px;
        border-radius: 10px;
...
<div class="container mt-4">
    <div class="gallery">
        <div class="large">
            <img src="../images/j1.jpg" alt="Main Image">
        </div>
        <div>
            <img src="../images/j2.jpg" alt="Small Image">
        </div>
        <div>
            <img src="../images/j3.jpg" alt="Small Image">
        </div>
        <!-- Video Instead of Image 3  -->
        <div class="overlay2">
            <video controls style=" height: 450px; max-width: 700px;">
                <source src="../vedio/jammu.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video> 
        </div> 
        <div class="overlay">
            <a href="../gallery/gallery5.php">View More Images</a>
        </div>
    </div>
</div> 
...
<div class="tour-info" style="margin-left: 20px; margin-top: 20px;">
    <div class="duration">
        <i class="fas fa-clock icon"></i> 6 Days / 5 Night
    </div>
    <div class="location">
...
<p style="font-size: 20px; margin-left: 20px;">✔️Accommodation – Stay in well-rated hotels/houseboats on a twin/triple-sharing basis. <br><br>
✔️Meals – Breakfast and dinner as per the itinerary. <br><br>
✔️Transport – Private vehicle for sightseeing and transfers. <br><br>
✔️Sightseeing – Visits to Srinagar, Gulmarg, Pahalgam, Sonmarg, and major tourist attractions. <br><br>
✔️Shikara Ride – Complimentary ride on Dal Lake (if mentioned in the itinerary). <br><br>
✔️Local Guide – Assistance during the trip for a smooth experience. <br><br>
✔️Parking & Toll Taxes – All applicable taxes, fuel charges, and driver allowances  <br><br>
✔️Group Tour Guide – Experienced guide for local sightseeing<br><br>
❌Airfare/Railway Tickets – Travel costs to/from Kashmir.<br><br>
❌Lunch & Personal Expenses – Extra meals, drinks, and personal shopping.<br><br>
❌Adventure Activities – Skiing, sledging, ATV rides, and pony rides (chargeable).<br><br>
❌Gondola (Phase 2 Ticket) – Not included (can be booked separately).<br><br>
❌Entry Fees & Permits – Any monument or garden entry charges.<br><br>
❌Medical & Travel Insurance – Not covered under the package.<br><br>
   


<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Srinagar: Shikara ride on Dal Lake, Mughal Gardens, houseboat stay.<br><br>
Gulmarg: Gondola ride, skiing, and snow activities.<br> <br>
Pahalgam: Betaab Valley, Aru Valley, and Lidder River.<br> <br>
Sonmarg: Thajiwas Glacier and pony rides.<br> <br>
Local Food: Enjoy Wazwan and Kahwa.<br> <br>
Culture: Visit temples, shrines, and local markets.<br> <br>
Shopping: Pashmina shawls, saffron, and dry fruits.<br> <br>
Group Activities: Bonfire, folk music, and fun experiences</p> <br>
...
<div class="site-section">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            ...
                            Arrive in Srinagar, check-in at the hotel/houseboat. Enjoy a Shikara ride on Dal Lake. Visit Mughal Gardens – Shalimar Bagh, Nishat Bagh, and Chashme Shahi. Explore Shankaracharya Temple for panoramic views of Srinagar. Return to the hotel for dinner and an overnight stay.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2. Srinagar to Gulmarg Excursion
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Drive to Gulmarg, the "Meadow of Flowers" (2 hours). Enjoy the Gondola Ride (Asia’s highest cable car) up to Apharwat Peak. Experience snow activities like skiing, snowboarding (seasonal). Visit Maharani Temple & St. Mary's Church. Return to Srinagar for an overnight stay.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3. Srinagar to Pahalgam (Mini Switzerland of India)
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Drive to Pahalgam, en route visit Awantipora Ruins & Saffron Fields. Explore Betaab Valley, Aru Valley & Baisaran Valley (Pony ride optional). Enjoy rafting on Lidder River (seasonal). Check-in at the hotel in Pahalgam, overnight stay.
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                4. Pahalgam to Sonmarg Excursion
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Drive to Sonmarg, the "Meadow of Gold". Enjoy breathtaking views of Thajiwas Glacier (Pony ride optional). Experience adventure activities like sledging & trekking. Return to Srinagar for an overnight stay..
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                                5. Srinagar Local EXploration
                        </h2>
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Visit Shankaracharya Temple & Hazratbal Shrine. Explore Lal Chowk Market for Kashmiri handicrafts. Enjoy a farewell dinner with traditional Kashmiri Wazwan. Overnight stay in Srinagar.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix">
                                6. Departure from Srinagar
                        </h2>
                        <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            After breakfast, check out and transfer to Srinagar Airport for departure. Trip ends with beautiful memories of Kashmir.
                            </div>
                        </div>
                    </div>
    ...
    <h3 class="text-center mt-5 mb-3">📍 Location of Jammu and Kashmir</h3>
  ...
  <iframe 
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1731620.0643740957!2d74.34017434726843!3d33.77817593513916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38e26c103b1a9c59%3A0x2a1035cb52e048a4!2sJammu%20and%20Kashmir!5e0!3m2!1sen!2sin!4v1712320704804!5m2!1sen!2sin" 
