...
<style>
    ...
    .overlay {
        ...
        background: url('../images/char5.jpg') center/cover no-repeat;
        color: white;
        font-size: 18px;
        border-radius: 10px;
...
<div class="container mt-4">
    <div class="gallery">
        <div class="large">
            <img src="../images/char4.jpg" alt="Main Image">
        </div>
        <div>
            <img src="../images/char2.jpg" alt="Small Image">
        </div>
        <div>
            <img src="../images/char3.jpg" alt="Small Image">
        </div>
        <!-- Video Instead of Image 3  -->
        <div class="overlay2">
            <video controls style=" height: 450px; max-width: 700px;">
                <source src="../vedio/char.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video> 
        </div> 
        <div class="overlay">
            <a href="/int.php/des.php/gallery/dhamgallery.php">View More Images</a>
        </div>
    </div>
</div> 
...
<div class="tour-info" style="margin-left: 20px; margin-top: 20px;">
    <div class="duration">
        <i class="fas fa-clock icon"></i> 11 Days / 10 Night
    </div>
    <div class="location">
        <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="Location Icon">
    Uttrakhand, Char Dham Yatra
    </div>  
</div> <br>
<br>
<h4 style="margin-left: 20px;"> Included and Excluded </h4> <br>
<p style="font-size: 20px; margin-left: 20px;">✔ Accommodation: Stay At Hotels/Guesthouses/Camps On A Twin/Triple Sharing Basis. <br> <br>
✔ Meals: Breakfast And Dinner As Per The Itinerary.<br> <br>
✓ Transportation: AC/Non-AC Vehicle For All Transfers And Sightseeing As Per Itinerary.<br> <br>
✓ Pick-Up & Drop: From Haridwar/Dehradun/Rishikesh (As Per Package).<br> <br>
✓ Sightseeing: Visit All Four Dhams - Yamunotri, Gangotri, Kedarnath, And Badrinath.<br> <br>
✓ Helicopter Assistance: Optional Helicopter Service For Kedarnath (Extra Charges Apply).<br> <br>
✓ VIP Darshan Assistance: Priority Darshan (If Included In The Package).<br> <br>
✓ Driver Allowance: Fuel, Toll Taxes, Parking, And State Entry Fees.<br> <br>
✔ Medical Kit: Basic First Aid And Oxygen Cylinders For High-Altitude Travel.<br> <br>
✔ Yatra Registration: Assistance With Mandatory Char Dham Registration.<br> <br>
✓ 24/7 Support: Dedicated On-Tour Assistance And
Guidance.<br> <br>
X Airfare/Train Tickets: Travel Expenses To/From The Starting Point.<br> <br>
X Palki/Pony/Doli Charges: For Yamunotri & Kedarnath
Trek.<br> <br>
X Personal Expenses: Laundry, Shopping, Phone Calls, And Tips.<br> <br>
X Temple Donations: Any Special Puja Or Aarti Charges. X Helicopter Tickets: Unless Explicitly Mentioned In The Package.<br> <br>
X Medical Expenses: Any Emergency Hospitalization Or Treatment.<br> <br>
X Extra Stay & Transport Costs: Due To Delays Like Weather, Landslides, Or Roadblocks.<br> <br>
X Anything Not Mentioned: Any Service/Item Not Listed In The Inclusions.<br> <br></p>
   


<h4 style="margin-left: 20px;">Highlights of the Tour</h4> <br>
<p style="font-size: 20px; margin-left: 20px;">Nanch Prayag: Visit the five sacred confluences—Devprayag, Rudraprayag, Karnaprayag, Nandaprayag, and Vishnuprayag.<br><br>
Spiritual Vibes: Witness mesmerizing Ganga Aarti at Gangotri & Badrinath.<br><br>
Scenic Beauty: Snow-capped peaks, lush valleys, and tranquil rivers.<br><br>
Mythological Significance: Legends associated with the Pandavas, Lord Shiva, and Lord Vishnu.<br><br>
Adventure Experience: Trekking to Kedarnath, hot springs in Yamunotri, and exploring Mana Village..</p> <br>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                1. Arrival in Haridwar - The Gateway to Char Dham
              </button>
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Pick-up from Delhi/Dehradun and transfer to Haridwar. Visit Har Ki Pauri for Ganga Aarti in the evening. Check-in at the hotel, dinner, and overnight stay in Haridwar
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                2. Haridwar to Barkot (180 km | 6-7 hrs)
              </button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Early morning drive to Barkot via Mussoorie. En route, visit Kempty Falls (optional). Check-in at the hotel, rest, and overnight stay in Barkot.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                3. Yamunotri Darshan - First Dham
              </button>
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Drive to Janki Chatti (45 km), then trek (6 km) or hire a pony/palki to reach Yamunotri Temple. Visit Yamuna River, Surya Kund, and Divya Shila. After darshan, return to Barkot for an overnight stay.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                4. Barkot to Uttarkashi (100 km | 4-5 hrs)
              </button>
            </h2>
            <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Drive to Uttarkashi, the home of Lord Shiva. Visit Kashi Vishwanath Temple & Shakti Temple. Check-in at the hotel, dinner, and overnight stay in Uttarkashi.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                5. Gangotri Darshan - Second Dham
              </button>
            </h2>
            <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Early morning drive to Gangotri Temple (100 km). Stop at Harsil Valley, known for its breathtaking beauty. Take a holy dip in the Bhagirathi River before darshan at Gangotri Temple. Return to Uttarkashi for an overnight stay.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix">
                6. Uttarkashi to Guptkashi (220 km | 8-9 hrs)
              </button>
            </h2>
            <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Long scenic drive towards Guptkashi. Visit the famous Ardh Narishwar Temple. Check-in at the hotel and rest for the night.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven">
                7. Kedarnath Darshan - Third Dham
              </button>
            </h2>
            <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Early morning drive to Gaurikund (30 km). Trek (16 km) or take a helicopter to Kedarnath Temple. Visit the Samadhi of Adi Shankaracharya behind the temple. Overnight stay at Kedarnath (hotel or guesthouse).
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight">
                8. Return from Kedarnath to Guptkashi
              </button>
            </h2>
            <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                After morning darshan, return to Gaurikund and drive back to Guptkashi. Check-in at the hotel, dinner, and overnight stay.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine">
                9. Guptkashi to Badrinath (190 km | 8-9 hrs)
              </button>
            </h2>
            <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Drive to Badrinath via Joshimath. En route, visit Narsingh Temple in Joshimath. Check-in at the hotel in Badrinath. Attend the evening aarti at Badrinath Temple.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen">
                10. Badrinath Darshan - Fourth Dham & Return to Rudraprayag
              </button>
            </h2>
            <div id="collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Take a holy dip in Tapt Kund before temple darshan. Visit Mana Village, Vyas Gufa, Bhim Pul, and Saraswati River. Drive back to Rudraprayag for an overnight stay.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven">
                11. Rudraprayag to Haridwar (160 km | 6-7 hrs) & Departure
              </button>
            </h2>
            <div id="collapseEleven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Drive back to Haridwar via Rishikesh. Visit Ram Jhula, Laxman Jhula, and Parmarth Niketan (optional). Drop-off at Haridwar/Dehradun for onward journey.
              </div>
            </div>
          </div>
        </div>
