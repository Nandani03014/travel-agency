...
<p style="font-size: 20px; margin-left: 20px;">✔️Accommodation (Hotels/Homestays)
<br><br>
...
<p style="font-size: 20px; margin-left: 20px;">Visit the ancient Key Monastery <br> <br>
Explore the highest villages Langza, Hikkim & Komic <br> <br>
Experience the stunning Chandratal Lake <br> <br>
Witness the beauty of Pin Valley National Park <br> <br>
Explore the spiritual Tabo & Dhankar Monasteries <br> <br>
Thrilling drive through Rohtang & Kunzum Pass <br></p>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                1. Arrival in Manali- Acclimatization
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Reach Manali & check-in to your hotel. Local sightseeing: Hadimba Temple, Mall Road, and Tibetan Monastery. Evening at leisure. Overnight stay in Manali.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                2.Manali to Kaza via Rohtang & Kunzum Pass(200 km, 8–9 hrs)

                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning drive towards Kaza. Cross Rohtang Pass (3,978m) & Kunzum Pass (4,551m). Visit Chandratal Lake (if road conditions allow). Reach Kaza by evening. Overnight stay in Kaza.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                3. Kaza – Key Monastery – Kibber – Hikkim – Komic – Langza
                            </button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Visit Key Monastery, the largest in Spiti Valley. Explore Kibber village, Hikkim (world’s highest post office), Komic (highest village), and Langza (famous for fossils). Return to Kaza for an overnight stay.
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                4. Kaza to Pin Valley & Mud Village Excursion
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Visit Pin Valley National Park, known for rare flora & fauna. Explore Mud Village, the last inhabited village in Pin Valley. Return to Kaza. Overnight stay in Kaza.
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                                5.Kaza to Tabo – Dhankar Monastery – Nako
                            </button>
                        </h2>
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Visit Tabo Monastery (1000+ years old). Explore Dhankar Monastery & Dhankar Lake (small trek). Reach Nako & explore Nako Lake. Overnight stay in Nako.
                            </div>
                        </div>
                    </div><div class="accordion-item">
                        <h2 class="accordion-header">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Drive towards Kalpa via Kinnaur. Visit Suicide Point & enjoy stunning views of Kinner Kailash. Check-in at hotel & explore Kalpa village. Overnight stay in Kalpa.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          7. Kalpa to Sangla – Chitkul Excursion(100 km, 5 hrs)
                        </button>
                        </h2>
                        <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Drive to Sangla Valley, known for apple orchards. Visit Chitkul, the last Indian village near the Tibet border. Return to Sangla for an overnight stay.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          8. Sangla to Shimla Drop
                            </button>
                        </h2>
                        <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                            Early morning departure for Shimla. Drop at Shimla/Chandigarh, marking the end of the tour.
                            </div>
                        </div>
                    </div>
                </div>
