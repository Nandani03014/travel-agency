...
<style>
    ...
    .overlay {
        ...
        background: url('../images/tara4.jpg') center/cover no-repeat;
        color: white;
        font-size: 18px;
        border-radius: 10px;
...
<div class="container mt-4">
    <div class="gallery">
        <div class="large">
            <img src="../images/tara.jpg" alt="Main Image">
        </div>
        <div>
            <img src="../images/tara1.jpg" alt="Small Image">
        </div>
        <div>
            <img src="../images/tara2.jpg" alt="Small Image">
        </div>
        <!-- Video Instead of Image 3  -->
        <div class="overlay2">
            <video controls style="width: 100%; height: auto; max-width: 300px;">
                <source src="../vedio/tara.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video> 
        </div> 
        <div class="overlay">
            <a href="/int.php/des.php/gallery/2ndgallery.php">View More Images</a>
        </div>
    </div>
</div> 
...
<div class="tour-info" style="margin-left: 20px; margin-top: 20px;">
    <div class="duration">
        <i class="fas fa-clock icon"></i> 2 Days / 1 Night
    </div>
    <div class="location">
