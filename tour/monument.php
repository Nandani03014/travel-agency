...
<div class="container mt-4">
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/shimla.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Christ Church Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/church.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/theatre.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Gaeity Theatre Tour Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/theatre.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/lodge.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Viceregal Lodge Travel Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/lodge.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/castle.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Naggar Castle Travel Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/castle.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/fort.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Sujanpur fort tour Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/fort.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>                       
 <!-- Card 6 -->
 <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
            <img src = ../images/kangra.jpg style = "width: 300px; height: 300px;">
          <h5 class="card-title">Kangra Fort tour Package</h5>
          <h6 class="card-text"> Starting from : <br>
          TAXES INCL/PERS </h6>
          <a href="../holidays/kangra.php" class="btn btn-success mt-3">Book My Trip</a>
        </div>
      </div> 
    </div>                       
