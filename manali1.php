...
<div class="container mt-4">
    <div class="gallery">
        ...
        <div class="overlay">
            <a href="gallery/gallery1.php">View More Images</a>
        </div>
    </div>
</div> 
...
<p style="font-size: 20px; margin-left: 20px;">Solang Valley: Adventure activities like paragliding, skiing (in winter), and ropeway rides. <br><br>
Rohtang Pass: Snow-covered paradise (subject to availability). <br><br>
Hadimba Temple: Ancient wooden temple surrounded by cedar forests. <br><br>
Vashisht Hot Springs: Natural sulfur springs with medicinal properties. <br><br>
Manikaran Sahib: Famous Sikh Gurudwara with hot springs. </p> <br>
