    ...
    <div id="carouselExample" class="carousel slide w-100" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../images/classic.jpg" class="d-block w-100" alt="Bike 1" style="width: 700px; height: 500px;">
            </div>
            <div class="carousel-item">
                <img src="../images/classic2.jpg" class="d-block w-100" alt="Bike 2" style="width: 700px; height: 500px;">
            </div>
            <div class="carousel-item">
                <img src="../images/classic3.jpg" class="d-block w-100" alt="Bike 3" style="width: 700px; height: 500px;">
            </div>
        </div>
...
<p style= "font-size: 20px;"> ✔️Royal Enfield Classic 350 for the entire tour<br> <br>
