    ...
    <div id="carouselExample" class="carousel slide w-100" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../images/avenger.jpg" class="d-block w-100" alt="Bike 1" style="width: 700px; height: 500px;">
            </div>
            <div class="carousel-item">
                <img src="../images/avenger2.jpg" class="d-block w-100" alt="Bike 2" style="width: 700px; height: 500px;">
            </div>
            <div class="carousel-item">
                <img src="../images/avenger3.jpg" class="d-block w-100" alt="Bike 3" style="width: 700px; height: 500px;">
            </div>
        </div>
...
<p style= "font-size: 20px;"> ✔️Bajaj Avenger Bike for the entire tour<br> <br>
